...
(4, 5, 5, 'Dell XPS 13 là chiếc laptop Windows tốt nhất mình từng dùng. Màn hình đẹp, hiệu năng mạnh và thiết kế sang trọng.', '["images/reviews/dell_review.png"]', 19, 'active'),
...
(7, 8, 4, 'Resort đẹp, dịch vụ tốt, nhân viên thân thiện. Trừ 1 sao vì giá hơi cao vào mùa cao điểm.', '["images/reviews/resort_review_1.png", "images/reviews/resort_review_2.png"]', 14, 'active'),
(8, 9, 5, 'Kem dưỡng da rất hiệu quả, da mình cải thiện rõ rệt sau 2 tuần sử dụng. Sẽ mua lại.', '["images/reviews/cream_review.png"]', 22, 'active'),
(9, 10, 5, 'iPad Air M1 là một thiết bị tuyệt vời cho công việc và giải trí. Màn hình đẹp, hiệu năng mạnh mẽ.', '["images/reviews/ipad_review.png"]', 17, 'active'),
(10, 11, 4, 'AirPods Pro chống ồn tốt, âm thanh chất lượng. Trừ 1 sao vì giá hơi cao.', NULL, 19, 'active'),
(11, 12, 5, 'Apple Watch Series 8 là chiếc smartwatch tốt nhất hiện nay. Tính năng theo dõi sức khỏe rất chính xác.', '["images/reviews/watch_review.png"]', 25, 'active'),
(12, 13, 5, 'Gaming PC cấu hình mạnh, chơi mọi game ở mức Ultra không giật lag. Rất hài lòng.', '["images/reviews/pc_review.png"]', 11, 'active'),
(13, 14, 4, 'Áo khoác chất lượng tốt, giữ ấm hiệu quả. Trừ 1 sao vì size hơi nhỏ so với bảng size.', NULL, 7, 'active'),
(14, 15, 3, 'Váy công sở chất vải tốt nhưng đường may chưa thực sự tinh tế. Giá hơi cao so với chất lượng.', '["images/reviews/dress_review.png"]', 20, 'active'),
(15, 16, 5, 'Giày Adidas cực kỳ thoải mái, đi cả ngày không mỏi chân. Rất đáng tiền.', '["images/reviews/shoes_review.png"]', 13, 'active'),
(16, 17, 4, 'Túi xách đẹp, da thật và đường may tỉ mỉ. Trừ 1 sao vì giá hơi cao.', NULL, 28, 'active'),
(17, 18, 5, 'Tour Hạ Long rất tuyệt vời, lịch trình hợp lý và hướng dẫn viên nhiệt tình. Đáng đồng tiền.', '["images/reviews/halong_review.png"]', 16, 'active'),
(18, 19, 4, 'Tour Nhật Bản tốt, khách sạn và phương tiện di chuyển đều ổn. Trừ 1 sao vì thời gian tự do hơi ít.', '["images/reviews/japan_review.png"]', 22, 'active'),
(19, 20, 5, 'Khách sạn 5 sao xứng đáng với giá tiền. Phòng đẹp, view biển tuyệt vời và dịch vụ chuyên nghiệp.', '["images/reviews/hotel_review.png"]', 9, 'active'),
(20, 21, 3, 'Vé máy bay đúng giờ nhưng dịch vụ trên máy bay không được tốt lắm. Đồ ăn không ngon.', NULL, 18, 'active'),
(21, 22, 5, 'Nhà hàng hải sản tuyệt vời, hải sản tươi ngon và không gian đẹp. Sẽ quay lại lần sau.', '["images/reviews/restaurant_review.png"]', 11, 'active'),
(22, 23, 4, 'Cà phê hạt Arabica thơm ngon, đậm đà. Trừ 1 sao vì giá hơi cao so với thị trường.', NULL, 24, 'active'),
(23, 24, 5, 'Thịt bò Wagyu ngon không thể tả, vân mỡ đẹp và hương vị tuyệt vời. Đáng đồng tiền.', '["images/reviews/beef_review.png"]', 19, 'active'),
...
(26, 27, 5, 'Bút Parker cao cấp, viết rất êm và thiết kế sang trọng. Rất phù hợp làm quà tặng.', '["images/reviews/pen_review.png"]', 17, 'active'),
...
(28, 29, 5, 'Vitamin tổng hợp Centrum rất tốt, sức khỏe cải thiện rõ rệt và ít bị cảm cúm hơn.', '["images/reviews/vitamin_review.png"]', 14, 'active'),
(29, 30, 4, 'Máy đo huyết áp chính xác, dễ sử dụng. Trừ 1 sao vì màn hình hơi nhỏ.', NULL, 26, 'active'),
(30, 31, 5, 'Phim Avengers: Endgame bản Blu-ray 4K cho trải nghiệm hình ảnh và âm thanh tuyệt vời. Đáng mua.', '["images/reviews/movie_review.png"]', 18, 'active'),
(31, 32, 4, 'Album BTS chất lượng tốt, nhiều quà tặng kèm theo. Trừ 1 sao vì giá hơi cao.', NULL, 23, 'active'),
(32, 33, 5, 'Game FIFA 23 đồ họa đẹp, gameplay thực tế và nhiều tính năng mới thú vị. Rất đáng chơi.', '["images/reviews/game_review.png"]', 19, 'active'),
(33, 34, 5, 'Sofa góc chất lượng tốt, da thật mềm mại và thiết kế sang trọng. Rất hài lòng.', '["images/reviews/sofa_review.png"]', 12, 'active'),
(34, 35, 4, 'Giường ngủ gỗ tự nhiên chắc chắn, thiết kế đẹp. Trừ 1 sao vì thời gian giao hàng hơi lâu.', NULL, 8, 'active'),
(35, 36, 3, 'Bàn ăn đẹp nhưng chất lượng chưa tương xứng với giá tiền. Mặt đá dễ bị xước.', '["images/reviews/table_review.png"]', 16, 'active'),
(36, 37, 5, 'Đèn trang trí phòng khách đẹp, ánh sáng dịu nhẹ và điều khiển từ xa tiện lợi.', '["images/reviews/lamp_review.png"]', 22, 'active'),
(37, 38, 5, 'Serum Vitamin C hiệu quả rõ rệt, da sáng và đều màu hơn sau 3 tuần sử dụng.', '["images/reviews/serum_review.png"]', 15, 'active'),
(38, 39, 4, 'Phấn nền Dior che phủ tốt, lâu trôi. Trừ 1 sao vì dễ bị lộ vệt khi da khô.', NULL, 20, 'active'),
(39, 40, 5, 'Gói Spa trọn gói tuyệt vời, massage thư giãn và đắp mặt nạ hiệu quả. Đáng đồng tiền.', '["images/reviews/spa_review.png"]', 18, 'active'),
(40, 41, 4, 'Toyota Camry 2023 vận hành êm ái, tiết kiệm nhiên liệu. Trừ 1 sao vì giá hơi cao.', '["images/reviews/car_review.png"]', 24, 'active'),
(41, 42, 5, 'Honda SH 350i động cơ mạnh mẽ, thiết kế sang trọng và vận hành êm ái. Rất hài lòng.', '["images/reviews/motorbike_review.png"]', 13, 'active'),
...
(43, 44, 5, 'Bỉm Pampers thấm hút tốt, không gây hăm và bé rất thoải mái khi sử dụng.', '["images/reviews/diaper_review.png"]', 14, 'active'),
...
(46, 47, 5, 'Hạt giống rau muống nảy mầm tốt, cây phát triển khỏe mạnh và cho năng suất cao.', '["images/reviews/seed_review.png"]', 12, 'active'),
...
(2, 5, 'Mình đang dùng MacBook Pro M1 và rất hài lòng với hiệu năng và thời lượng pin.', NULL, 'active'),
(2, 2, 'Dell XPS 13 cũng là một lựa chọn tốt nếu bạn quen dùng Windows.', NULL, 'active'),
(3, 5, 'Mình đã học khóa này và thấy rất hiệu quả. Giáo viên nhiệt tình và có phương pháp giảng dạy dễ hiểu.', NULL, 'active'),
(4, 2, 'Bài viết rất hữu ích. Mình sẽ đi Phú Quốc vào tháng sau, cảm ơn vì những chia sẻ!', NULL, 'active'),
...
(7, 9, 'iPad Air M1 có đáng để nâng cấp từ iPad Air 4 không bạn?', NULL, 'active'),
(7, 7, 'Theo mình thì rất đáng, hiệu năng tăng đáng kể và màn hình cũng đẹp hơn.', 14, 'active'),
(8, 10, 'AirPods Pro có chống ồn tốt không? Mình làm việc ở văn phòng ồn.', NULL, 'active'),
(8, 11, 'Chống ồn rất tốt, mình dùng ở không gian đông người vẫn nghe nhạc rõ.', 16, 'active'),
(9, 12, 'Apple Watch có theo dõi giấc ngủ chính xác không?', NULL, 'active'),
(9, 9, 'Khá chính xác, nó ghi lại được các giai đoạn ngủ sâu, ngủ nông và thời gian thức giấc.', 18, 'active'),
(10, 13, 'Bài viết rất chi tiết. Mình đang định build một bộ PC tương tự.', NULL, 'active'),
(10, 14, 'Bạn có thể chia sẻ nhiệt độ CPU và GPU khi chơi game không?', NULL, 'active'),
(10, 10, 'CPU khoảng 65-70 độ và GPU khoảng 75-80 độ khi chơi game nặng, nhiệt độ an toàn.', 21, 'active'),
(11, 15, 'Mình cũng đang tìm áo khoác cho mùa đông. Bạn đã mua loại nào chưa?', NULL, 'active'),
(11, 16, 'Mình gợi ý áo khoác của Uniqlo, vừa ấm vừa thời trang mà giá cả hợp lý.', 23, 'active'),
(12, 17, 'Mẫu váy thứ 3 rất đẹp, bạn mua ở đâu vậy?', NULL, 'active'),
(12, 12, 'Mình mua ở Elise, giá khoảng 750k, chất vải rất tốt.', 25, 'active'),
(13, 18, 'Mình cũng đang dùng Ultraboost, đi rất êm nhưng giá hơi cao.', NULL, 'active'),
(13, 19, 'Có mẫu nào tương tự nhưng giá rẻ hơn không bạn?', NULL, 'active'),
(13, 13, 'Bạn có thể thử Adidas Pureboost hoặc Nike React, giá rẻ hơn nhưng vẫn êm.', 28, 'active'),
(14, 20, 'Mình gợi ý túi xách của Pedro, chất lượng tốt mà giá chỉ khoảng 2 triệu.', NULL, 'active'),
(15, 21, 'Bài viết rất hữu ích. Mình sẽ đi Hạ Long vào tháng sau.', NULL, 'active'),
(15, 22, 'Bạn có thể chia sẻ thêm về các nhà hàng ngon ở Hạ Long không?', NULL, 'active'),
(15, 15, 'Mình gợi ý nhà hàng Hải Sản Hạ Long và Nhà hàng Cua Biển, hải sản tươi ngon mà giá cả hợp lý.', 32, 'active'),
(16, 23, 'Bài viết rất chi tiết. Mình đang lên kế hoạch đi Nhật vào năm sau.', NULL, 'active'),
(16, 24, 'Bạn có thể chia sẻ thêm về thủ tục xin visa Nhật không?', NULL, 'active'),
(16, 16, 'Visa Nhật khá dễ xin nếu bạn có đầy đủ giấy tờ chứng minh tài chính và lịch trình rõ ràng.', 35, 'active'),
(17, 25, 'Mình cũng đã ở Pullman Đà Nẵng và rất hài lòng với dịch vụ.', NULL, 'active'),
(18, 26, 'Mẹo săn vé rất hữu ích. Mình vừa áp dụng và tiết kiệm được 2 triệu cho chuyến đi Nhật.', NULL, 'active'),
(19, 27, 'Mình sẽ đi Nha Trang tháng sau và sẽ thử nhà hàng Ocean Palace.', NULL, 'active'),
(20, 28, 'Mình vừa mua cà phê Arabica và pha theo hướng dẫn của bạn, ngon tuyệt!', NULL, 'active'),
(21, 29, 'Mình vừa mua thịt bò Wagyu và sẽ thử chế biến theo cách bạn chia sẻ.', NULL, 'active'),
(22, 30, 'Khóa học Python này có phù hợp cho người mới bắt đầu không?', NULL, 'active'),
(22, 22, 'Rất phù hợp cho người mới, khóa học bắt đầu từ cơ bản và có nhiều bài tập thực hành.', 42, 'active'),
(23, 31, 'Mình cũng vừa đọc xong cuốn này và rất tâm đắc với chương 3 về cách giao tiếp.', NULL, 'active'),
(24, 32, 'Mình gợi ý bút Mont Blanc, sang trọng và phù hợp làm quà tặng cho sếp.', NULL, 'active'),
(25, 33, 'Mình đang dùng thuốc bổ gan của Traphaco và thấy khá hiệu quả.', NULL, 'active'),
(26, 34, 'Mình cũng đang dùng Centrum và thấy sức khỏe cải thiện rõ rệt.', NULL, 'active'),
(27, 35, 'Máy đo huyết áp Omron rất chính xác, mình đã so sánh với kết quả đo tại bệnh viện.', NULL, 'active'),
(28, 36, 'Mình cũng vừa xem Endgame bản 4K, trải nghiệm hình ảnh và âm thanh tuyệt vời.', NULL, 'active'),
(29, 37, 'Album BTS này có bao nhiêu phiên bản vậy bạn?', NULL, 'active'),
(29, 29, 'Có 4 phiên bản khác nhau, mỗi phiên bản có photobook và quà tặng khác nhau.', 50, 'active'),
(30, 38, 'FIFA 23 có gì khác biệt so với FIFA 22 không bạn?', NULL, 'active'),
(30, 30, 'Đồ họa đẹp hơn, gameplay thực tế hơn và có thêm World Cup nữ.', 52, 'active'),
(31, 39, 'Sofa này có bền không bạn? Mình đang cần mua một bộ cho phòng khách.', NULL, 'active'),
(31, 31, 'Rất bền, mình dùng được 2 năm rồi vẫn như mới, da không bị bong tróc.', 54, 'active'),
(32, 40, 'Giường gỗ tự nhiên có ưu điểm gì so với gỗ công nghiệp vậy bạn?', NULL, 'active'),
(32, 32, 'Gỗ tự nhiên bền hơn, đẹp hơn theo thời gian và thân thiện với môi trường hơn.', 56, 'active'),
(33, 41, 'Mình cũng đang tìm bàn ăn, bạn đã mua ở đâu vậy?', NULL, 'active'),
